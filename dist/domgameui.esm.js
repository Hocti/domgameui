...
let n$3 = class {
  ...
  get styleSheet() {
    ...
    const s3 = this.t;
    if (e$4 && t2 === void 0) {
      const e2 = s3 !== void 0 && s3.length === 1;
      e2 && (t2 = o$3.get(s3)), t2 === void 0 && ((this.o = t2 = new CSSStyleSheet()).replaceSync(this.cssText), e2 && o$3.set(s3, t2));
    }
    return t2;
  }
  toString() {
...
const r$5 = (t2) => new n$3(typeof t2 == "string" ? t2 : t2 + "", void 0, s$3), i$2 = (t2, ...e2) => {
  const o2 = t2.length === 1 ? t2[0] : e2.reduce((e3, s3, o3) => e3 + ((t3) => {
    if (t3._$cssResult$ === !0)
      return t3.cssText;
    if (typeof t3 == "number")
      return t3;
  ...
  if (e$4)
    ...
    for (const e2 of o2) {
      ...
      n3 !== void 0 && o3.setAttribute("nonce", n3), o3.textContent = e2.cssText, s3.appendChild(o3);
    }
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: i$1, defineProperty: e$3, getOwnPropertyDescriptor: r$4, getOwnPropertyNames: h$2, getOwnPropertySymbols: o$2, getPrototypeOf: n$2 } = Object, a$1 = globalThis, c$1 = a$1.trustedTypes, l$2 = c$1 ? c$1.emptyScript : "", p$1 = a$1.reactiveElementPolyfillSupport, d$1 = (t2, s3) => t2, u$1 = { toAttribute(t2, s3) {
  switch (s3) {
    case Boolean:
      t2 = t2 ? l$2 : null;
      break;
  ...
  return i2;
} }, f$1 = (t2, s3) => !i$1(t2, s3), y$1 = { attribute: !0, type: String, converter: u$1, reflect: !1, hasChanged: f$1 };
...
class b extends HTMLElement {
  ...
  static createProperty(t2, s3 = y$1) {
    if (s3.state && (s3.attribute = !1), this._$Ei(), this.elementProperties.set(t2, s3), !s3.noAccessor) {
  ...
  static finalize() {
    ...
    if (this.finalized = !0, this._$Ei(), this.hasOwnProperty(d$1("properties"))) {
      const t3 = this.properties, s3 = [...h$2(t3), ...o$2(t3)];
      for (const i2 of s3)
  ...
  _$EO(t2, s3) {
    ...
    if (e2 !== void 0 && i2.reflect === !0) {
      const r2 = (i2.converter?.toAttribute !== void 0 ? i2.converter : u$1).toAttribute(s3, i2.type);
  ...
  requestUpdate(t2, s3, i2, e2 = !1, r2) {
    if (t2 !== void 0) {
      if (i2 ?? (i2 = this.constructor.getPropertyOptions(t2)), !(i2.hasChanged ?? f$1)(e2 ? r2 : this[t2], s3))
        return;
      this.C(t2, s3, i2);
    }
  ...
  C(t2, s3, i2) {
    this._$AL.has(t2) || this._$AL.set(t2, s3), i2.reflect === !0 && this._$Em !== t2 && (this._$Ej ?? (this._$Ej = /* @__PURE__ */ new Set())).add(t2);
  }
  async _$EP() {
    ...
    if (!this.hasUpdated) {
      ...
      if (t3.size > 0)
        for (const [s4, i2] of t3)
          i2.wrapped !== !0 || this._$AL.has(s4) || this[s4] === void 0 || this.C(s4, this[s4], i2);
    }
    let t2 = !1;
    const s3 = this._$AL;
    try {
      t2 = this.shouldUpdate(s3), t2 ? (this.willUpdate(s3), this._$E_?.forEach((t3) => t3.hostUpdate?.()), this.update(s3)) : this._$ET();
    } catch (s4) {
      throw t2 = !1, this._$ET(), s4;
    }
    t2 && this._$AE(s3);
  }
  willUpdate(t2) {
...
\f\r"'\`<>=]|("|')|))|$)`, "g"), p = /'/g, g = /"/g, $ = /^(?:script|style|textarea|title)$/i, y = (t2) => (i2, ...s3) => ({ _$litType$: t2, strings: i2, values: s3 }), x = y(1), w$1 = Symbol.for("lit-noChange"), T = Symbol.for("lit-nothing"), A = /* @__PURE__ */ new WeakMap(), E = r$3.createTreeWalker(r$3, 129);
function C(t2, i2) {
...
const P = (t2, i2) => {
  ...
  for (let i3 = 0; i3 < s3; i3++) {
    ...
    l2 += c2 === f ? s4 + n$1 : d2 >= 0 ? (o2.push(a2), s4.slice(0, d2) + e$2 + s4.slice(d2) + h$1 + x2) : s4 + h$1 + (d2 === -2 ? i3 : x2);
  }
...
function N(t2, i2, s3 = t2, e2) {
  if (i2 === w$1)
    return i2;
  let h2 = e2 !== void 0 ? s3._$Co?.[e2] : s3._$Cl;
  const o2 = c(i2) ? void 0 : i2._$litDirective$;
  return h2?.constructor !== o2 && (h2?._$AO?.(!1), o2 === void 0 ? h2 = void 0 : (h2 = new o2(t2), h2._$AT(t2, s3, e2)), e2 !== void 0 ? (s3._$Co ?? (s3._$Co = []))[e2] = h2 : s3._$Cl = h2), h2 !== void 0 && (i2 = N(t2, h2._$AS(t2, i2.values), h2, e2)), i2;
}
class S {
  constructor(t2, i2) {
  ...
  u(t2) {
    const { el: { content: i2 }, parts: s3 } = this._$AD, e2 = (t2?.creationScope ?? r$3).importNode(i2, !0);
    E.currentNode = e2;
  ...
  p(t2) {
    ...
    for (const s3 of this._$AV)
      s3 !== void 0 && (s3.strings !== void 0 ? (s3._$AI(t2, s3, i2), i2 += s3.strings.length - 2) : s3._$AI(t2[i2])), i2++;
  }
}
class M {
  get _$AU() {
  ...
  constructor(t2, i2, s3, e2) {
    this.type = 2, this._$AH = T, this._$AN = void 0, this._$AA = t2, this._$AB = i2, this._$AM = s3, this.options = e2, this._$Cv = e2?.isConnected ?? !0;
  }
  get parentNode() {
  ...
  g(t2) {
    const { values: i2, _$litType$: s3 } = t2, e2 = typeof s3 == "number" ? this._$AC(t2) : (s3.el === void 0 && (s3.el = V.createElement(C(s3.h, s3.h[0]), this.options)), s3);
  ...
  T(t2) {
    ...
    let s3, e2 = 0;
    for (const h2 of t2)
      e2 === i2.length ? i2.push(s3 = new M(this.k(l$1()), this.k(l$1()), this, this.options)) : s3 = i2[e2], s3._$AI(h2), e2++;
  ...
  _$AI(t2, i2 = this, s3, e2) {
    ...
    if (h2 === void 0)
      ...
      for (t2 = h2[0], n3 = 0; n3 < h2.length - 1; n3++)
        r2 = N(this, e3[s3 + n3], i2, n3), r2 === w$1 && (r2 = this._$AH[n3]), o2 || (o2 = !c(r2) || r2 !== this._$AH[n3]), r2 === T ? t2 = T : t2 !== T && (t2 += (r2 ?? "") + h2[n3 + 1]), this._$AH[n3] = r2;
    }
    o2 && !e2 && this.O(t2);
  }
  O(t2) {
...
const j = (t2, i2, s3) => {
  const e2 = s3?.renderBefore ?? i2;
  let h2 = e2._$litPart$;
  if (h2 === void 0) {
    const t3 = s3?.renderBefore ?? null;
    e2._$litPart$ = h2 = new M(i2.insertBefore(l$1(), t3), t3, void 0, s3 ?? {});
  }
...
function anyPlayerPress(ips) {
  for (let k2 in ips.player)
    if (YES(ips.player[k2]) || PAUSE(ips.player[k2]))
      return parseInt(k2);
  return -1;
}
function anyPress(ips) {
  return click(ips) ? InputSource.mouse : YES(ips.system) || PAUSE(ips.system) ? InputSource.system : anyPlayerPress(ips) >= 0 ? InputSource.player : void 0;
}
...
const o = { attribute: !0, type: String, converter: u$1, reflect: !1, hasChanged: f$1 }, r$1 = (t2 = o, e2, r2) => {
  ...
  if (s3 === void 0 && globalThis.litPropertyMetadata.set(i2, s3 = /* @__PURE__ */ new Map()), s3.set(r2.name, t2), n3 === "accessor") {
    const { name: o2 } = r2;
    return { set(r3) {
 ...
 */
function r(r2) {
  return n2({ ...r2, state: !0, attribute: !1 });
}
/**
 * @license
 * Copyright 2017 Google LLC
...
function e(e2, r2) {
  return (n3, s3, i2) => {
    ...
    if (r2) {
      const { get: e3, set: r3 } = typeof s3 == "object" ? n3 : i2 ?? (() => {
        const t2 = Symbol();
        return { get() {
          return this[t2];
        }, set(e4) {
...
updater.style.zIndex = "9999";
updater.style.color = "blue";
updater.style.background = "rgba(255,255,255,0.7)";
...
class UIMaster extends EventTarget {
  constructor(_div) {
    ...
    ControlWrap.getInstance().addListener("changeLastInputIndex", this.changeInputType), this.rootElement.addEventListener("mousedown", this.mouseChange.bind(this)), this.rootElement.addEventListener("mousemove", this.mouseChange.bind(this)), show(this._div);
  }
  static getInstance() {
    return UIMaster._instance;
  }
  static init(div) {
    return UIMaster._instance = new UIMaster(div), MI = UIMaster.getInstance(), UIMaster._instance;
  }
  get width() {
...
class UIParentBase extends UIInteractiveBase {
  ...
  */
  ...
  updated(_changedProperties) {
    ...
    this.cursorChild && this.uiChildren.indexOf(this.cursorChild) == -1 && (MI.removeIfActive(this.cursorChild), this.setCursor(void 0)), setTimeout(() => {
      this.autoFindCursor();
    });
  }
...
_UIPanelBase.styles = [__superGet$4(_UIPanelBase, _UIPanelBase, "styles"), i$2`
        :host {
            ${centerCSS}
            border:${s2(0.3)} solid yellow;
            border-radius:${s2(1.5)};
...
class UISelectableBase extends UIChildBase {
  ...
  update(changedProperties) {
    super.update(changedProperties), changedProperties.has("active") && this.active && (MI.setActiveComponent(this) ? this.setParentsCursorToMe() : this.active = !1);
...
class CheckBox extends UISelectableBase {
  ...
  captureInput(ip) {
    return YES(ip) ? (this.value = !this.value, !0) : !1;
  }
}
__decorateClass$3([
  n2({ type: Boolean })
...
` : ""}
  ...
  static addPanel(str) {
    ...
    return j(x`${str}`, ap), MI.showPanel(ap), ap;
  }
  ...
  captureInput(ip) {
    return YES(ip) ? (this.onYes(), !0) : NO(ip) ? (this.withCancel ? this.onCancel() : this.onNo(), !0) : super.captureInput(ip);
  }
};
...
export {
  ...
  nextTick,
  nowSelectable,
  removeElementWithIndex,
  s2 as s,
  styled,
  w
};
//# sourceMappingURL=domgameui.esm.js.map
